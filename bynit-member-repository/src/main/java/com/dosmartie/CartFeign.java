...
//    public ResponseEntity<?> placeOrder(@RequestBody CartOrderRequest orderRequest);
...
//    public BaseResponse<List<CartProductResponse>> clearCartItem(@RequestParam("email") String email);
//
//    @GetMapping(value = CartUrls.CART + CartUrls.VIEW)
//    public BaseResponse<List<CartProductResponse>> getCartItems(@RequestParam("email") String email,);
//}
