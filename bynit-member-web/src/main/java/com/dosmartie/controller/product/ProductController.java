...
//        return productFeign.getProductViaCategory(category, page, size, getMerchantEmail(token));
//    }
//
//    @PreAuthorize("hasAuthority('MERCHANT') or hasAuthority('CUSTOMER')")
//    @GetMapping
...
//        return productFeign.getProduct(searchParam, page, size, getMerchantEmail(token));
//    }
//
//    @PreAuthorize("hasAuthority('MERCHANT')")
...
//        return productFeign.deleteProductVariant(itemSku, jwtTokenUtil.getUsernameFromToken(token.substring(7)));
//    }
//
//    @PreAuthorize("hasAuthority('MERCHANT')")
//    @DeleteMapping
...
//        return productFeign.deleteProduct(itemSku, jwtTokenUtil.getUsernameFromToken(token.substring(7)));
//    }
//
...
//        return productFeign.getAllProducts(page, size, getMerchantEmail(token));
//    }
//
//    @PreAuthorize("hasAuthority('MERCHANT')")
...
//        return productFeign.updateStock(cartProductRequest);
//    }
//
...
//        return productFeign.rateProduct(orderRatingRequest, jwtTokenUtil.getUsernameFromToken(token));
//    }
//
//    @PreAuthorize("hasAuthority('CUSTOMER')")
